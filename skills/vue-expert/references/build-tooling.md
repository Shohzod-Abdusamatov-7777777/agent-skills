...
export default defineConfig({
  ...
  ssr: {
    ...
    noExternal: ['your-ui-library']
  }
})

// For separate client/server builds
...
| `build.ssr` | Server-side rendering build |
| `css.preprocessorOptions` | SCSS/LESS global imports |
| `resolve.alias` | Path aliases (@/, @components/) |
| `optimizeDeps.include` | Pre-bundle dependencies |
